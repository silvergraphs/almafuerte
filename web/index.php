...
<table width="300" border="0" align=center>
  <tr>
    ...
    <br /><span class="lema">"Hacia el desarrollo en salud de nuestra juventud, el avance intelectual por el ejercicio del pensamiento, y la formación integral del hombre por la maduración de sus sentimientos."</span></td>
  </tr>
  <tr>
<!-- LOGIN -->
<?php
...
<div align=center>
<table width="880" height="0" border="0" align=center class=boxslider>
  <tr>
  <br />
    </tr>
    <tr>
...
<div class="ism-slider" data-radios="false" data-play_type="loop" id="my-slider">
  <ol>
    <li>
      <img src="ism/image/slides/_u/1502496408336_121605.jpg">
    </li>
    <li>
      <img src="ism/image/slides/_u/1502496408131_182268.jpg">
    </li>
    <li>
      <img src="ism/image/slides/_u/1502496407765_666852.jpg">
    </li>
    <li>
      <img src="ism/image/slides/_u/1502496407555_820571.jpg">
    </li>
    <li>
      <img src="ism/image/slides/_u/1502496407331_918260.jpg">
    </li>
    <li>
      <img src="ism/image/slides/_u/1502496407400_493797.jpg">
    </li>
    <li>
      <img src="ism/image/slides/_u/1502496407271_310971.jpg">
    </li>
  </ol>
</div>
</th>
...
<!-- RSS -->
<div align=center>
<table width="880" height="0" border="0" align=center class=boxcircular>
  <tr>
  <br />
    <th height="0" colspan="2" align=center scope="row" class=boxtitulo>Noticias</th>
    </tr>
    <tr>
    <th colspan="2" scope="row"><div class=boxcontent>Últimas ediciones de la web: <a href=changelog.txt>Click para ver Changelog</a><br /><br /><iframe src="https://www.facebook.com/plugins/page.php?href=https%3A%2F%2Fwww.facebook.com%2FEscuela-Tecnica-8-Almafuerte-136023523209070%2F&tabs=timeline&width=500&height=500&small_header=true&adapt_container_width=true&hide_cover=true&show_facepile=false&appId" width="500" height="500" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowTransparency="true"></iframe></th>
    </tr>
</table>
</div>
<!-- RSS -->
...
<table width="880" height="0" align=center class=boxcircular>
  <tr>
  <br />
    <th height="0" colspan="2"  align=center scope="row" class=boxtitulo>Sobre la escuela</th>
    </tr>
    <tr>
    <th colspan="2" scope="row"><br /><div class=boxcontent>Desde 1949, nuestra escuela forma técnicos que desarrollan, luego de egresar, importantes tareas en la industria local, nacional y extranjera. <br><br>
Contamos con equipamiento de primer nivel tecnológico como, por ejemplo: tornos y centros de mecanizado de Control Numérico Computarizado, Salas de Informática Multimedia, Gabinetes de Neumática y Robótica.<br /><br>
La E.E.S.T. Nº 8 de Lanús es reconocida en el ámbito local, zonal y provincial por ser una de las escuelas técnicas con mas premios y menciones en ferias y exposiciones.
</div> </th>
    </tr>
</table>
</div>
...
<table width="880" height="0" align=center class=boxcircular>
  <tr>
  <br />
    <th height="0" colspan="2"  align=center scope="row" class=boxtitulo>Especialidades</th>
    </tr>
    <tr>
    <th colspan="2" scope="row"><br /><div class=boxcontent>

	<input type="hidden" name="especialidad" value="informatica">
  [descripcionBreveInformatica]<br> <a href="<?php echo $url; ?>/especialidades?especialidad=informatica">Link Info</a><br><br>
  [descripcionBreveConstrucciones]<br> <a href="<?php echo $url; ?>/especialidades?especialidad=construcciones">Link Construcciones</a><br><br>
  [descripcionBreveElectromecanica]<br> <a href="<?php echo $url; ?>/especialidades?especialidad=electromecanica">Link Electromecanica</a><br><br>
