...
<table width="880" height="0" align=center border="0" class=boxcircular>
  <tr>
  <br />
    <th height="0" colspan="2"  align=center scope="row" class=boxtitulo>Usuario</th>
    </tr>
    <tr>
    ...
    if ($control == "misdatos") {
		include ($datosUsuario);
	}

	if ($control == "configuracion") {
		include ($configUsuario);
	}

	if ($control == "cambiarClave") {
		include ($cambiarClave);
	}

	if ($control == "cambiarUsuario") {
		include ($cambiarUsuario);
	}

	if ($control == "cambiarEmail") {
		include ($cambiarEmail);
	}

  if ($control == "materiales") {
    include ($materiales);
  }
