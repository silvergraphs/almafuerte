...
<table width="880" height="0" align=center border="0" class=boxcircular>
  <tr>
  <br />
    <th height="0" colspan="2"  align=center scope="row" class=boxtitulo>Cerrar sesión</th>
    </tr>
    <tr>
    <th colspan="2" scope="row">
    <div class=boxcontent>
    <br>
    La sesión se cerrará en breve...
    <br>	<br>	Si la página no se redirecciona automáticamente, hacé <a href=index.php>click aquí</a>.	<br>
</table>
</div>
<!-- LOGOUT -->
