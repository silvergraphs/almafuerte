...
<table width="880" height="0" align=center border="0" class=boxcircular>
  <tr>
  <br />
    <th height="0" colspan="2"  align=center scope="row" class=boxtitulo>Error</th>
    </tr>
    <tr>
    <th colspan="2" scope="row">
    <div class=boxcontent>
    <br>
    <?php		$pagina = $_GET['pagina'];	$error = $_GET['error'];		if (($pagina or $error) == NULL) {	echo "Ningun error especificado<br>";	}else{	echo "Error en ".$pagina."<br><br>";	echo $error."<br>";	}		?>
    <br>	<br>	<button class="button button-rounded button-flat-primary" type=submit onClick="window.history.back();">Volver</button>	<br>
</table>
</div>
<!-- ERROR -->
